...
const AttractionInfo = () => {
  const images = [
    ...
    "/attractions_assets/mushroom/mushroomATT4.jpg",
    "/attractions_assets/mushroom/mushroomATT5.jpg",
    "/attractions_assets/mushroom/mushroomATT6.jpg",
  ];

  const reviews = [
    { name: "Alexa", text: "The mushroom-shaped rocks in Moalboal are breathtaking! The snorkeling around them is fantastic, with vibrant marine life everywhere. Definitely a must-visit spot!", date: "Nov 30, 2024", rating: 4.5 },
    { name: "Liam ", text: "Moalboal's Mushroom Rocks are truly unique! Perfect for photos and exploring. Make sure to bring water shoes, as the rocks can be a bit sharp.", date: "Dec 1, 2024", rating: 4 },
    { name: "Sophia ", text: "Absolutely stunning view! The Mushroom Rocks are a natural wonder, and the surrounding waters are so clear. Great spot for a quiet day by the sea.", date: "Dec 2, 2024", rating: 5 },
