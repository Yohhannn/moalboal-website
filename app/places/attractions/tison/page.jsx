...
const AttractionInfo = () => {
  const images = [
    ...
    "/attractions_assets/tison/tisonATT4.jpg",
  ];

  const reviews = [
    { name: "Angel ", text: " didn’t expect Tison Canyon to be this amazing! The jumps and slides were so much fun, and the water was so refreshing. It’s incredible knowing this beauty is just here in Cebu!", date: "Nov 30, 2024", rating: 4.5 },
    { name: "John Rey", text: "Tison Canyon surprised me big time! It’s so much more than just waterfalls—the adventure, the laughs, and the stunning views made it worth every second. Proud na naa ni sa Cebu!", date: "Dec 1, 2024", rating: 4 },
    { name: "Recmar", text: "Grabe ka nindot sa Tison Canyon! Super sulit ang adventure, especially the natural slides and the crystal-clear water. If you’re in Cebu, you really have to try this experience!", date: "Dec 2, 2024", rating: 5 },
