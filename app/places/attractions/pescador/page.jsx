...
const AttractionInfo = () => {
  ...
  const reviews = [
    { name: "Johnny", text: "Such a beautiful snorkelling & scuba spot. Pescador Island , is only a short Bangka boat trip off Panagsama beach Moalboal. Totally worth it", date: "Nov 30, 2024", rating: 4.5 },
    { name: "Melissa Smith", text: "Nice snorkeling spot for corals especially, overall it took 1 hour snorkeling around there and we saw lots of corals and fish, it was enough an enjoyable spot for us and our tour brought us to sardines and turtles to Moalboal, we swam 1 hour also there. Tour spots are fair I think, I would recommend 👌", date: "Dec 1, 2024", rating: 4 },
    { name: "Steve  Brown", text: "It's an awesome day trip! Take a boat from almost anywhere in Moalboal, sit back, relax and enjoy the 25 to 35 minute ride to Pescador Island. It's just a small little outcrop in the middle of the straight between Cebu and Negros. We don't usually go for the Island itself (there's nothing really on it and it is protected), but it is a favorite spot to hang out, snorkel, dive, and enjoy the beautiful coral reefs surrounding it. I spent my 49th birthday out there. We had three boats full of family and just partied!", date: "Dec 2, 2024", rating: 5 },
